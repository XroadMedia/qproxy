...
public final class PropertiesConfigBuilder implements ConfigBuilder {
	 ...
	 *            path (including filename) to a properties file accessible on the filesystem.
	 ...
	 *            path (including filename) to a properties file accessible via context classloader.
	 *            May be null, in which case it is ignored.
	 * @return PropertiesConfigBuilder instance
	 */
